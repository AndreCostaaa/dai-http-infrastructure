...
public class ServiceTest extends GarageTest {
    ...
    void fetchOne() throws SQLException, ParseException {
        ServiceDisplay service = Service.fetchById(1);
        ...
        assertEquals(service, new Service(1, 6, 4, 10, 61, "RAS", false, 4, sqlDateCreated, sqlDateCarArrival,
                sqlDateCarProcessing, sqlDateCarDone, sqlDateCarLeft));
    }
    ...
    void fetchAll() throws SQLException {
        ...
        for (ServiceDisplay service : services) {
//            assertNotNull(service);
//            assertInstanceOf(ServiceDisplay.class, service);
