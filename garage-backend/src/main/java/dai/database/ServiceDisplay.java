...
public record ServiceDisplay(int id,
        ...
        static ServiceDisplay fetchNext(ResultSet resultSet) throws SQLException {
                ...
                Employee mechanic = mechanicId == 0 ? null
                                : new Employee(mechanicId, mechanicFirstName, mechanicLastName, mechanicPhone, roleId,
                                                specializationId);
                ...
                Client client = new Client(clientId, clientFirstName, clientLastName, clientPhone, clientEmail, street,
